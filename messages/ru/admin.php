...
return [
    ...
    'Forum' => 'Форум',
    'Sizes' => 'Размеры',
    'Image size is too small. Minimal width is [min}px' => 'Размер изображения слишком мал. Минимальная ширина {min}px',
    'Image size is too big. Maximal width is [max}px' => 'Размер изображения слишком велик. Максимальная ширина {max}px',
